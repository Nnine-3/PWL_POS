...
$barangs = BarangModel::select('barang_id', 'barang_kode', 'barang_nama', 'harga_beli', 'harga_jual', 'kategori_id')->with('kategori');
    ...
    public function store_ajax(Request $request)
    {
        ...
        // Jika berhasil, buat data dan kembalikan pesan sukses JSON
        BarangModel::create($request->all());
    ...
    public function delete_ajax(Request $request, $id)
    {
        try {
            ...
            return response()->json(['status' => false, 'message' => 'Data barang gagal dihapus karena masih terkait dengan data lain.'], 500);
        }
    }
}